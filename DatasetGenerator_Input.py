...
medium_templates = [
    "Make a {color_name} Input with '{label}'",
    "Create a {color_name} Input that says '{label}'",
    "Generate a {color_name} Input labeled '{label}'",
    "Build a {color_name} '{label}' Input",
    "Design a {color_name} Input showing '{label}'",
    "I need a {color_name} Input with '{label}' text",
    "Can you create a {color_name} Input that displays '{label}'?",
    "Please make a {color_name} Input saying '{label}'",
    "A {color_name} Input labeled '{label}'",
    "A {color_name} '{label}' Input",
    "Input in {color_name} with '{label}' text",
    "Add a {color_name} '{label}' Input",
    "Insert {color_name} Input '{label}'",
    "Show me a {color_name} Input for '{label}'",
    ...
    "Build functional {color_name} Input '{label}'",
    "Create responsive {color_name} '{label}' Input",
    "Design modern {color_name} Input '{label}'",
    "Generate styled {color_name} '{label}' control",
    "Make interactive {color_name} '{label}' component",
    "Create dynamic {color_name} Input '{label}'",
    "Build elegant {color_name} '{label}' Input",
    "Design sleek {color_name} Input '{label}'",
    "Set up a {color_name} Input reading '{label}'",
    "Create Input: {color_name} with text '{label}'",
    "New {color_name} Input: '{label}'",
    "Quick {color_name} Input with '{label}'",
    "{color_name} Input implementation for '{label}'",
    "Simple {color_name} Input: '{label}'",
    "Basic {color_name} Input with text '{label}'",
    "{color_name} Input - '{label}' text",
    "Add {color_name} Input, text: '{label}'",
    "Include {color_name} Input saying '{label}'"
]

complex_templates = [
    "Make a {color_name} Input with '{label}' and {special} styling",
    "Create a {color_name} Input that says '{label}' with {special}",
    "Generate a {color_name} Input labeled '{label}' using {special}",
    "I need a {color_name} Input with '{label}' and {special} styling",
    "Can you create a {color_name} Input that displays '{label}' and has {special}?",
    "Please make a {color_name} Input saying '{label}' with {special} effects",
    "A {special} {color_name} Input labeled '{label}'",
    "Input component with {color_name} color, '{label}' text, and {special}",
    "Add a {color_name} '{label}' Input with {special}",
    "How about a {color_name} '{label}' Input with {special}?",
    "Erstelle einen {color_name} Input mit '{label}' und {special}",
    "Design a {special} {color_name} element for '{label}'",
    "Build {color_name} Input '{label}' featuring {special}",
    "Create styled {color_name} Input with '{label}' using {special}",
    "Generate {special} styled {color_name} '{label}' Input",
    "Make {color_name} component '{label}' with {special} design",
    "Show {special} {color_name} Input displaying '{label}'",
    "Render {color_name} '{label}' element with {special}",
    "Develop a {special} {color_name} Input containing '{label}'",
    "Construct {special} {color_name} '{label}' control with styling",
    "Produce a {color_name} Input '{label}' featuring {special} design",
    "Craft {special} interactive {color_name} Input '{label}'",
    "Build {color_name} UI control '{label}' with {special} appearance",
    "Generate {special} {color_name} action Input '{label}'",
    "Create {color_name} clickable '{label}' element with {special}",
    "Design {special} interactive {color_name} Input '{label}'",
    "Make {color_name} trigger element '{label}' using {special}",
    "Develop {special} {color_name} interface Input '{label}'",
    "Construct a {color_name} '{label}' interface with {special}",
    "Generate {special} {color_name} user control '{label}'",
    "Build functional {color_name} Input '{label}' featuring {special}",
    "Create responsive {color_name} '{label}' Input with {special}",
    "Design modern {special} {color_name} Input '{label}'",
    "Generate styled {color_name} '{label}' control using {special}",
    "Make interactive {special} {color_name} '{label}' component",
    "Create dynamic {color_name} Input '{label}' with {special}",
    "Build elegant {special} {color_name} '{label}' Input",
    "Design sleek {color_name} Input '{label}' featuring {special}",
    "Mach einen {special} {color_name} Input für '{label}'",
    "Generiere {color_name} Input '{label}' mit {special} Stil",
    "Baue einen {special} {color_name} '{label}' Input",
    "Erstelle {color_name} Element '{label}' mit {special}",
     "Design {color_name} Input '{label}' with {special} and rounded corners",
    "{color_name} Input '{label}' using {special} plus shadow",
    "Custom {color_name} Input '{label}' with {special} styling",
    "Advanced {color_name} Input '{label}' featuring {special}",
    "{color_name} Input '{label}' styled with {special} effects",
    "Professional {color_name} Input '{label}' with {special}",
    "Modern {color_name} Input '{label}' using {special} design",
    "{color_name} '{label}' Input with {special} animation",
    "Enhanced {color_name} Input '{label}' with {special}",
...
while len(prompts_list) < target_samples and attempts < max_attempts:
    ...
    code = f'<Input placeholder={label} className="bg-{color}-{intensity} {consolidate_styles(chosen_specials)}"></Input>'
